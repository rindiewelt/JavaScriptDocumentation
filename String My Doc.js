...
b = a.slice(1,4)     //"ell" gada a[1:3] | ditambah 1 dari last idx
...
String.prototype.capitalizeAll = function (){ var arr = this.split(" "); var res = []; for(i of arr){ res.push(i.charAt(0).toUpperCase() + i.slice(1).toLowerCase()) } return res.join(" ")}
...
/*~~~ Compare string ~~~*/
a = "12";  b = "bz";    //if a<b => -1, if a==b => 0, if a>b => 1
